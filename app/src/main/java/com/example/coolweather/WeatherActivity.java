...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weatherString!=null){   //本地有这个数据，直接显示
            ...
            mWeatherId=weather.basic.weatherId;//记下当前的weatherId
            showWeatherInfo(weather);
        }else {
            //否则，去服务器查询天气
            mWeatherId=getIntent().getStringExtra("weather_id");//获取weather_id
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                requestWeather(mWeatherId);
                //Toast.makeText(WeatherActivity.this,"id是"+mWeatherId,Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onFailure(Call call, IOException e) {//请求网络失败的回调
                runOnUiThread(new Runnable() {//切换至UI主线程
                    ...
                    public void run() {
                        ...
                        swipeRefreshLayout.setRefreshing(false);//关闭下拉刷新显示
                    }
                });
            }
